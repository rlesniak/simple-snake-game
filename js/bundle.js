...
/***/ function(module, exports, __webpack_require__) {
	...
	var options = {
	  events: {
	    onScoreChange: function onScoreChange(score) {
	...
	var g = new _game2.default(options);
	g.init();
	g.start();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function (_Context) {
	  _inherits(Game, _Context);
	  ...
	  function Game() {
	    ...
	    _this.snake = new _snake2.default();
	    _this.food = new _food2.default();
	    _this.api = new _api2.default(options.events);
	  ...
	  _createClass(Game, [{
	    ...
	    key: 'checkCollisionWithBody',
	    value: function checkCollisionWithBody() {
	      var head = this.snake.head;
	      var body = this.snake.getBody();
	
	      var isCollision = !!body.slice(0, -1).filter(function (frag) {
	        return frag.x === head.x && frag.y === head.y;
	      }).length;
	    ...
	    key: 'checkCollisionWithBoundary',
	    value: function checkCollisionWithBoundary() {
	      var head = this.snake.head;
	      var boardSize = { x: this.ctxSize.w - this.rectSize, y: this.ctxSize.h - this.rectSize };
	...
	var Context = function () {
	  ...
	  _createClass(Context, [{
	    ...
	    value: function drawRect(x, y) {
	      ...
	      var isFilled = arguments.length <= 3 || arguments[3] === undefined ? false : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Snake = function (_Context) {
	  _inherits(Snake, _Context);
	  ...
	  _createClass(Snake, [{
	    ...
	    value: function generateBody() {
	      var startPosition = arguments.length <= 0 || arguments[0] === undefined ? null : arguments[0];
	    ...
	    key: 'checkPosition',
	    value: function checkPosition(x, y) {
	      var coords = this.head;
	
	      return coords.x === x && coords.y === y;
	    }
	  }, {
	    key: 'draw',
	    value: function draw(dir, snakeAdditionalLength) {
	      var _this2 = this;
	      ...
	      switch (dir) {
	        case 'l':
	          newHead = { x: head.x - this.rectSize, y: head.y };break;
	        case 'r':
	          newHead = { x: head.x + this.rectSize, y: head.y };break;
	        case 'd':
	          newHead = { x: head.x, y: head.y + this.rectSize };break;
	        case 'u':
	          newHead = { x: head.x, y: head.y - this.rectSize };break;
	        default:
	          break;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _food_types = __webpack_require__(9);
	
	var _food_types2 = _interopRequireDefault(_food_types);
	...
	var Food = function (_Context) {
	  _inherits(Food, _Context);
	  ...
	  function Food() {
	    ...
	    _this.props = {
	      type: _food_types2.default.basic,
	      pos: { x: 0, y: 0 }
	    };
	    return _this;
	  }
	  ...
	  _createClass(Food, [{
	    ...
	    value: function generateRandomPoint(multiplier) {
	      var point = Math.round(Math.random() * multiplier);
	    ...
	    value: function setType() {
	      ...
	      if (_.random(0, 100) > 70) {
	        type = _.sample(_food_types2.default);
	      } else {
	        type = _food_types2.default.basic;
	      }
	    ...
	    key: 'isNotWithinArray',
	    value: function isNotWithinArray(arr) {
	      var _this2 = this;
	
	      if (arr.find(function (item) {
	        return item.x === _this2.props.pos.x && item.y === _this2.props.pos.y;
	      })) {
	        return true;
	      }
	...
	var Api = function () {
	  ...
	  _createClass(Api, [{
	    ...
	    value: function setCallbacks() {
	      ...
	      this.onScoreChange = callbacks.onScoreChange || function () {};
	      this.onGameOver = callbacks.onGameOver || function () {};
	      this.onGameStart = callbacks.onGameStart || function () {};
	      this.onGamePause = callbacks.onGamePause || function () {};
	    }
	  }, {
	    key: "score",
